...
intro_duration = 5
intro_text = TextClip("Hola Mundo!", fontsize=70, color='white', size=video_clip.size)
...
watermark_size = 60
watermark_text = TextClip("Jorgito Code", fontsize=watermark_size, color='white', align='West', size=(w, watermark_size))
